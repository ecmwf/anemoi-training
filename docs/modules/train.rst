...
The `GraphForecaster object` in `forecaster.py` is responsible for the forward pass of the model itself. 
The key-functions in the forecaster that users may want to adapt ot their own applications are:
