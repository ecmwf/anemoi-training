...
class GraphForecaster(pl.LightningModule):
    ...
    def __init__(
        ...
        *,
        ...
        scalars = {"variable": (-1, variable_scaling), "loss_weights_mask": ([-2, -1], torch.ones((2, 1)))}
    ...
    def training_weights_for_imputed_variables(
        ...
        loss_weights_mask = torch.ones_like(batch[0, 0, 0, 0, 0])
        ...
        # update scaler!!! to add the loss_weights_mask to the loss function
        if "loss_weights_mask" in self.loss.scalar:
            self.loss.add_scalar(dimension=[-2, -1], scalar=loss_weights_mask, name="loss_weights_mask")
        return
